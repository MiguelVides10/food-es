...
<section class="form-container">
   ...
   <form action="" method="post">
      ...
      <input type="number" name="number" required placeholder="Número de teléfono" class="box" min="0" max="9999999999" maxlength="10">
      ...
      <input type="password" name="cpass" required placeholder="Confirmar contraseña" class="box" maxlength="50" oninput="this.value = this.value.replace(/\s/g, '')">
